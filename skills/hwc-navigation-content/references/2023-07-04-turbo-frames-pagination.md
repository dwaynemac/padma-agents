...
<turbo-frame id="paginated-content">
  <table>
    ...
    <tr>
      <td colspan="4">
        <nav>
          <a href="/app/assets/fonts?page=A" data-turbo-action="advance" aria-current="page">A</a>
          <a href="/app/assets/fonts?page=B" data-turbo-action="advance">B</a>
          <a href="/app/assets/fonts?page=C" data-turbo-action="advance">C</a>
        </nav>
      </td>
    </tr>
    </tfoot>
